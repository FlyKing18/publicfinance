        ...
        <div id="zhukuai">
            ...
            <div id="neirong" class="pingpu">
                <div id="neirongbiaoti">
                    <h2>基本设置——结算方式设置</h2><hr />
                </div>
                <div class="zhuti"> 
                    <div id="workspacecolor">
                       <table border="0" width = "650" height="400">
                           <form action="" method="get">
                                <select name="jiesuanfangshi" id="jiesuanfangshi" multiple size="20" style="width:300px">
                                <option><tr><th>代码</th><th>结算方式</th></tr></option>
                                <%
                                    ArrayList<JieSuanFangShiSheZhi> list = (ArrayList<JieSuanFangShiSheZhi>)session.getAttribute("allJieSuanFangShiSheZhiInfo");
                                    for(JieSuanFangShiSheZhi JieSuanFangShiSheZhiA : list){
                                        out.println("<option value=\"Jsfs\"><tr><td>"+JieSuanFangShiSheZhiA.getDm()+"</td><td>"+JieSuanFangShiSheZhiA.getMc()+"</td></tr></option>");
                                    }
                                %>
                                </select>
                        ...
                        <div>
                            <form action="servlet/ZenJiaServlet" method="post">
                                                                            代&nbsp&nbsp码:<input type="text" name="daima" /><br />
                                                                            结算方式:<input type="text" name="jiesuanfangshi" /><br />
